...
import { Award, CalendarIcon, Flame, MapPinIcon, Target, X } from 'lucide-react';
        ...
        <Dialog.Root open={isOpen} onOpenChange={onClose}>
            ...
            <Dialog.Content className={cn(
                ...
                <Dialog.Description className="">
                    <Card className="bg-[#f9f9f9] shadow-md rounded-[4px] overflow-hidden" style={{
                            ...
                            <div className="flex-1 p-5 relative">
                                ...
                                <div className="flex flex-col items-start mt-10 mb-5">
                                    <div className="w-[70px] h-[70px] bg-gray-200 rounded-full mr-4 overflow-hidden flex items-center justify-center">
                                        <img src={profilePictureUrl} alt="User" className="w-full h-full object-cover" />
                                    </div>
                                    <div>
                                        {/* <div className="text-[11px] text-gray-500">ubaidziad #881288</div> */}
                                        <h3 className="text-[17px] font-semibold mt-[2px]">{data?.userName}</h3>
                                    </div>
                                </div>
